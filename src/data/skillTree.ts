  ...
  node('skills.game', 'Game', [
    node('skills.game.unreal-engine', 'Unreal Engine', [
      ...
      node('skills.game.unreal-engine.profiling-optimization', 'Low Level Profiling & Optimization', [
        ...
        leaf('skills.game.unreal-engine.profiling-optimization.cpu-profiling', 'CPU Profiling'),
        leaf('skills.game.unreal-engine.profiling-optimization.gpu-profiling', 'GPU Profiling'),
        leaf('skills.game.unreal-engine.profiling-optimization.memory-profiling', 'Memory Profiling'),
      ...
      node('skills.game.unreal-engine.plugin-module-development', 'Plugin & Module Development', [
        leaf('skills.game.unreal-engine.plugin-module-development.runtime-modules', 'Runtime Modules'),
        leaf('skills.game.unreal-engine.plugin-module-development.editor-modules', 'Editor Modules'),
      ...
      node('skills.game.unreal-engine.build-engineering', 'Build Engineering', [
        leaf('skills.game.unreal-engine.build-engineering.ubt', 'UBT'),
        leaf('skills.game.unreal-engine.build-engineering.uht', 'UHT'),
        leaf('skills.game.unreal-engine.build-engineering.reflection-system', 'Reflection System'),
        leaf('skills.game.unreal-engine.build-engineering.build-configurations', 'Build Configurations'),
        leaf('skills.game.unreal-engine.build-engineering.packaging', 'Packaging'),
      ...
      node('skills.game.unreal-engine.pcg', 'PCG', [
        ...
        leaf('skills.game.unreal-engine.pcg.custom-pcg-nodes', 'Custom PCG Nodes'),
        leaf('skills.game.unreal-engine.pcg.runtime-generation', 'Runtime Generation'),
        leaf('skills.game.unreal-engine.pcg.spline-based', 'Spline-based'),
        leaf('skills.game.unreal-engine.pcg.rule-based', 'Rule-based'),
      ]),
